      ...
      >
         <Container as={Stack} maxW={'auto'} py={10} px={{ base: 8, md: 10, lg: 20 }}>
            <SimpleGrid columns={{ base: 2, md: 3, lg: 6 }} spacing={8}>
               <Stack align={'flex-start'}>
                  ...
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }}></Link>
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }}></Link>
               </Stack>
               <Stack align={'flex-start'}>
                  <ListHeader>Product</ListHeader>
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }}></Link>
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }} as={NavLink} to='/pricing'></Link>
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }}></Link>
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }}></Link>
                  <Link _hover={{ textDecoration: 'none', color: 'whiteAlpha.500' }}></Link>
         ...
         <Box py={10}>
            <Flex
               ...
               {/* <Image src='' alt='brand-logo' boxSize='44px' borderRadius={50} /> */}
            </Flex>
